...
extension UILabel{
    ...
    func imageWithText(image : UIImage , textKey : String){
        ...
        func halfTextColorChange (fullText : String , changeText : String ) {
            ...
            attribute.addAttribute(NSAttributedString.Key.foregroundColor, value: UIColor.primaryColor , range: range)
            self.attributedText = attribute
        }
        
        func halfTextColorChangeForCoinPair (fullText : String , changeText : String, color: UIColor) {
            let strNumber: NSString = fullText as NSString
            let range = (strNumber).range(of: changeText)
            let attribute = NSMutableAttributedString.init(string: fullText)
